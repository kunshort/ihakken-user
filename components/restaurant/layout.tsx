...
export function RestaurantLayout({ branchId }: RestaurantLayoutProps) {
  ...
  const { data: menuItems = [], isLoading: itemsLoading, error: itemsError } = useGetMenuItemsQuery()
  const { data: categories = mockCategories, isLoading: categoriesLoading } = useGetCategoriesQuery()
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="sticky top-0 z-20">
        <div className="relative h-48 md:h-64 bg-gradient-to-r from-teal-600 to-teal-800 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="hidden md:block md:col-span-1">
            <div className="bg-gradient-to-b from-teal-50 to-transparent rounded-lg p-4 sticky top-24">
